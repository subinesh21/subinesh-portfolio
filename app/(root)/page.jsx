...
import Me from "@/public/image/me1.jpeg";
			...
			<Section>
				<div className="mx-auto w-[82%] max-w-screen-2xl grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden">
					<motion.div
						...
						<motion.h2
							className="text-gray-500 text-xl md:text-2xl font-semibold tracking-wide my-2 md:my-3"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.3,
							...
							AI Automation Engineer | Full-Stack Developer | AI & Data Science Student
						</motion.h2>
						<motion.p
							...
							AI & Data Science student building full-stack web products with a focus on SEO/GEO optimization. 
							I combine technical expertise in Next.js, AI/LLMs, and blockchain with a passion for creating 
							content-first digital experiences. Currently working on sustainable e-commerce platforms and 
							AI-driven search optimization strategies.
						</motion.p>
						<motion.div
			...
			<Section>
				<div className="relative md:h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
						...
						<Hr />
						<motion.p
							className="title text-xl mt-4 tracking-wider text-gray-500 leading-[1.7rem] mb-5 max-w-full md:max-w-md lg:max-w-xl"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.2,
							...
							AI automation is my primary work — building custom LLM
							<span className="bg-transparent md:bg-gray-100 bg-opacity-50 xl:bg-transparent">
								{" "}
								workflows for real clients across Singapore & Chennai.
							</span>
						</motion.p>
						<motion.div
							initial={{ y: 40, opacity: 0 }}
				...
				<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
						...
						<motion.p
							...
							<a href="mailto:subinesh21@proton.me?subject=Hello&body=Hello Subinesh,">
								subinesh21@proton.me
							</a>
						</motion.p>
						{/* icons */}
						<div className="flex justify-center items-center space-x-4">
							<motion.a
								href="mailto:subinesh21@proton.me?subject=Hello&body=Hello Subinesh,"
							...
							<motion.a
								href="https://github.com/Subinesh21"
								target="_blank"
								rel="noopener noreferrer"
							...
							<motion.a
								href="https://www.linkedin.com/in/subinesh-b-92125a323"
								target="_blank"
								rel="noopener noreferrer"
