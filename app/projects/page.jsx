...
// images
import Intervyou1 from "@/public/Websites/thulira.png";
import Intervyou2 from "@/public/Websites/chennaigreengifts.png";
import Intervyou3 from "@/public/Websites/reetz.png";
			...
			<main className="overflow-hidden">
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<div className="text-xs uppercase tracking-[4px] text-gray-400 font-medium mb-2">Primary Work · 2025</div>
						<h2 className="text-2xl font-bold tracking-wider mb-3">
							AI Automation Solutions
						</h2>
						<p className="text-gray-600 text-justify title text-lg">
							Building custom AI automation workflows for international clients — Talentor Singapore and Chennai Green Gifts. Leveraging Gemini, Llama, and automation frameworks to streamline business processes and reduce manual work.
						</p>{" "}
						<div className="flex flex-wrap gap-2 mt-4 mb-4 text-sm">
							<span className="bg-gray-900 text-white px-3 py-1 rounded-full">Python</span>
							<span className="bg-gray-900 text-white px-3 py-1 rounded-full">Gemini AI</span>
							<span className="bg-gray-900 text-white px-3 py-1 rounded-full">Llama</span>
							<span className="bg-gray-900 text-white px-3 py-1 rounded-full">LLMs</span>
							<span className="bg-gray-900 text-white px-3 py-1 rounded-full">APIs</span>
						</div>
						<div className="mt-1">
							<Button variation="primary">
								<Link href="projects/ai-automation-solutions">More</Link>
							</Button>
							<Button variation="secondary">
								<a
									href="https://talentor.com/l/talentor-singapore"
									target="_blank"
