...
import Me5 from "@/public/image/me1.jpeg";
		...
		2024: [
			{
				icon: faTrophy,
				title: "Winner",
				subtitle: "Innovators Day (Built AI Voice Assistant using Python)",
				date: "2024",
				color: "from-yellow-400 to-orange-500",
			},
			{
				icon: faAward,
				title: "Blockchain Development Intern Certificate",
				subtitle: "Vodafone Intelligent Solutions (VOIS)",
				date: "Apr 2024",
						...
						<div>
							...
							<div className="flex items-center gap-2">
								<p className="text-gray-600 text-justify title text-lg">
									Currently pursuing Bachelor of Engineering in Artificial Intelligence & Data Science at Anand Institute of Higher Technology with a focus on LLMs, generative models, and data-driven optimization. 
									<br />
									<br />
									My academic studies provide a strong foundational bridge between theoretical machine learning concepts and production-ready, scalable software solutions. Expected graduation in 2026.
								</p>
							</div>
