...
const skillCategories = {
	web: {
		...
		icon: CodepenIcon,
		description: "Building responsive, modern, and SEO-optimized web products",
		languages: [
	...
	api: {
		title: "SEO & GEO",
		icon: WebhookIcon,
		description: "Search Engine & Generative Engine Optimization",
		languages: [
			{ name: "Generative Engine Optimization (GEO)", highlight: true },
			{ name: "Technical SEO", highlight: true },
			{ name: "On-page SEO", highlight: true },
			{ name: "Off-page SEO", highlight: false },
			{ name: "Content Strategy", highlight: false },
		],
		tools: [
			"Google Analytics",
	...
	ai: {
		...
		icon: ActivityIcon,
		description: "Integrating intelligent LLM features and prompt engineering",
		languages: [
			{ name: "LangChain", highlight: true },
			{ name: "FAISS", highlight: true },
			{ name: "Prompt Engineering", highlight: true },
			{ name: "AI Chatbots", highlight: true },
			{ name: "Gemini", highlight: true },
			{ name: "Llama", highlight: false },
	...
	mobile: {
		...
		icon: MobileIcon,
		description: "Smart contracts, decentralized storage, and Android apps",
		languages: [
			{ name: "Solidity", highlight: true },
			{ name: "Smart Contracts", highlight: true },
			{ name: "Kotlin", highlight: true },
			{ name: "Web3.js", highlight: false },
			{ name: "IPFS", highlight: false },
		],
		tools: [
			"Android Studio",
			"MetaMask",
