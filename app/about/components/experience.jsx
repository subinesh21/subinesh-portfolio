...
const experiences = [
	{
		...
		position: "AI & ML Learning Intern",
		type: "Remote",
		location: "Remote",
		description:
			"Worked on real-world AI/ML tasks including data preprocessing and neural networks. Built foundation for understanding how AI search engines process and retrieve information.",
		skills: ["Python", "AI/ML", "Data Preprocessing", "Neural Networks"],
	},
	{
		id: 2,
		startDate: "Jan 2025",
		...
		location: "Remote",
		description:
			"Developed a blockchain-based land registry system. Researched, documented, and presented complex technical concepts — skills directly transferable to SEO content creation and technical documentation.",
		skills: ["Blockchain", "Solidity", "Technical Documentation", "Research"],
	},
	{
		id: 3,
		startDate: "2023",
		...
		location: "Remote",
		description:
			"Building complete web solutions for Singapore-based clients using Next.js, React, and modern web technologies. Projects include roofing/contracting firm websites with complex animations, SEO optimization, and Vercel deployment.",
		skills: ["Next.js", "React", "TypeScript", "GSAP", "Vercel", "SEO optimization"],
	},
];
